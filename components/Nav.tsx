        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="flex items-center gap-3 ml-2 border-l border-neutral-800 pl-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-xs text-neutral-500 hover:text-[#1e90ff] transition-colors"
            >
              IG
            </a>
            <a
      ...
      >
        <div className="px-6 pb-4 flex flex-col gap-4 border-t border-neutral-800 pt-4">
          {links.map(({ href, label }) => (
            <Link
              ...
              className={`text-sm tracking-wide transition-colors ${
                pathname === href ? "text-[#1e90ff]" : "text-neutral-400 hover:text-white"
              }`}
            >
              {label}
            </Link>
          ...
          <div className="flex gap-4 pt-2 border-t border-neutral-800">
            <a href="https://instagram.com/PhotobyFH3" target="_blank" rel="noopener noreferrer" className="text-xs text-neutral-500 hover:text-[#1e90ff] transition-colors">IG</a>
            <a href="https://instagram.com/fh3.lx" target="_blank" rel="noopener noreferrer" className="text-xs text-neutral-500 hover:text-[#1e90ff] transition-colors">IG LX</a>
            <a href="mailto:FH3@franciscohermosilloiii.com" className="text-xs text-neutral-500 hover:text-[#1e90ff] transition-colors">Email</a>
          </div>
        </div>
      </div>
    </header>
