  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      <header className="mb-16">
        <p className="text-xs font-mono tracking-[0.3em] text-[#1e90ff] uppercase mb-3">Credits</p>
      ...
      <div className="border border-neutral-800 p-8 bg-neutral-900/30">
        <p className="text-xs font-mono text-[#1e90ff] uppercase tracking-widest mb-4">Confidential Work</p>
