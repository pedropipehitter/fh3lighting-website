  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-20">
      <header className="mb-16">
        <p className="text-xs font-mono tracking-[0.3em] text-[#1e90ff] uppercase mb-3">Portfolio</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-neutral-800">
        {photoProjects.map((project) => (
          ...
          >
            ...
            <div className="p-5">
              <h2 className="text-sm font-medium text-white group-hover:text-[#1e90ff] transition-colors mb-1">
                {project.title}
              </h2>
