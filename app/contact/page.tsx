  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-20">
      <header className="mb-16">
        <p className="text-xs font-mono tracking-[0.3em] text-[#1e90ff] uppercase mb-3">Contact</p>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              type="text"
              required
              className="w-full bg-neutral-900 border border-neutral-800 text-white px-4 py-3 text-sm focus:outline-none focus:border-[#1e90ff] transition-colors"
            />
          </div>
          <div>
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={6}
            className="w-full bg-neutral-900 border border-neutral-800 text-white px-4 py-3 text-sm focus:outline-none focus:border-[#1e90ff] transition-colors resize-none"
          />
        </div>

        <button
          type="submit"
          className="px-8 py-3 bg-[#1e90ff] hover:bg-[#3da0ff] text-white text-sm tracking-wide transition-colors"
        >
          Send Message
        </button>
      </form>
      ...
      <div className="mt-16 pt-10 border-t border-neutral-800 space-y-3">
        ...
        <a
          ...
          className="block text-neutral-400 hover:text-[#1e90ff] transition-colors text-sm"
        >
